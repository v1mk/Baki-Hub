...
local library = {flags = {}, toggled = true, keybind = Enum.KeyCode.RightShift, dragSpeed = 0.01}
...
local themes = {
    Dark = {
        ...
        TabToggleEnabled = Color3.fromRGB(10, 10, 10),
        ...
        ButtonMouseOver = Color3.fromRGB(15, 15, 15),
        ToggleEnabled = Color3.fromRGB(60, 60, 60),
        ToggleEnabledMouseOver = Color3.fromRGB(60, 60, 60),
        ToggleDisabled = Color3.fromRGB(10, 10, 10),
        ToggleDisabledMouseOver = Color3.fromRGB(15, 15, 15),
        Box = Color3.fromRGB(10, 10, 10),
        BoxFocused = Color3.fromRGB(15, 15, 15),
        Slider = Color3.fromRGB(10, 10, 10),
        SliderMouseOver = Color3.fromRGB(15, 15, 15),
        SliderFill = Color3.fromRGB(60, 60, 60),
        SliderFillSliding = Color3.fromRGB(60, 60, 60),
        Dropdown = Color3.fromRGB(10, 10, 10),
        DropdownMouseOver = Color3.fromRGB(15, 15, 15),
        DropdownContent = Color3.fromRGB(5, 5, 5),
        ColorPicker = Color3.fromRGB(5, 5, 5),
    ...
    BakiHub = {
        ...
        SliderFill = Color3.fromRGB(255, 145, 145),
        SliderFillSliding = Color3.fromRGB(255, 145, 145),
        Dropdown = Color3.fromRGB(221, 139, 139),
        DropdownMouseOver = Color3.fromRGB(226, 144, 144),
        DropdownContent = Color3.fromRGB(255, 170, 170),
        ColorPicker = Color3.fromRGB(255, 170, 170),
        ColorPickerBoxes = Color3.fromRGB(255, 124, 124)
    },
...
function utility.drag(obj)
    ...
    inputService.InputChanged:Connect(function(input)
        if (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) and dragging then
            utility.tween(obj, {library.dragSpeed}, {Position = UDim2.new(objPosition.X.Scale, objPosition.X.Offset + (input.Position.X - start.X), objPosition.Y.Scale, objPosition.Y.Offset + (input.Position.Y - start.Y))})
            end
    end)
end
...
local tor = utility.create("ScreenGui", {})
